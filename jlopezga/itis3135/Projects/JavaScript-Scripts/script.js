document.addEventListener("DOMContentLoaded", function() {
    ...
    const submitTextId = document.getElementById("submit-text");
    const showPolygonId = document.getElementById("show-polygon");
    const taxEvasionId = document.getElementById("tax-evasion");
    const tipId = document.getElementById("tip");
    const funFactId = document.getElementById("fun-fact");
    const randomQuoteId = document.getElementById("random-quote");
    const easterEggId = document.getElementById("easter-egg");


    submitTextId.addEventListener("click", function(){
        submitText();    
    });

    showPolygonId.addEventListener("click", function(){
        showPolygon();    
    });

    taxEvasionId.addEventListener("click", function(){
        taxEvasion();    
    });

    tipId.addEventListener("click", function(){
        tip();    
    });

    funFactId.addEventListener("click", function(){
        funFact();    
    });

    randomQuoteId.addEventListener("click", function(){
        randomQuote();    
    });

    easterEggId.addEventListener("click", function(){
        easterEgg();    
    });
